...
export const UI: Record<string, Bilingual> = {
  ...
  editDetails: { ta: "திருத்து", en: "Edit" },
  editHint: { ta: "தேதி & நேரத்தை மாற்ற திருத்து பொத்தானை அழுத்தவும்.", en: "Click the edit pen to change date & time." },
  saveChanges: { ta: "மாற்றங்களைச் சேமி", en: "Save Changes" },
  cancelEdit: { ta: "ரத்து", en: "Cancel" },
  calculate: { ta: "கணக்கிடு", en: "Calculate" },
  setupTitle: { ta: "வரவேற்கிறோம்", en: "Welcome" },
  setupSubtitle: { ta: "தொடங்குமுன் உங்கள் விருப்பங்களைத் தேர்ந்தெடுக்கவும்.", en: "Choose your preferences to get started." },
  chooseLanguage: { ta: "மொழி", en: "Language" },
  chooseChartStyle: { ta: "கட்ட வகை", en: "Chart Style" },
  langTamil: { ta: "தமிழ்", en: "Tamil" },
  langEnglish: { ta: "ஆங்கிலம்", en: "English" },
  continueBtn: { ta: "தொடரு", en: "Continue" },
  changeLater: { ta: "மொழியை பின்னர் மேல் பட்டியில் மாற்றலாம்.", en: "You can toggle the language anytime from the top bar." },
  ...
  // KN Rao concepts
  knRaoTab: { ta: "கே.என். ராவ்", en: "KN Rao" },
  knRaoTitle: { ta: "கே.என். ராவ் கோட்பாடுகள்", en: "KN Rao Concepts" },
  knRaoSubtitle: {
  ...
  charaKarakas: { ta: "சர காரகர்கள் (ஜைமினி)", en: "Chara Karakas (Jaimini)" },
  charaKarakasDesc: {
  ...
  charaDasha: { ta: "சர தசா (ஜைமினி)", en: "Chara Dasha (Jaimini)" },
  charaDashaDesc: {
    ta: "ராசி அடிப்படையிலான தசா கால வரிசை.",
    en: "Sign-based dasha timeline — KN Rao's signature predictive tool.",
  },
  directSeq: { ta: "நேர் (சுழற்சி)", en: "Direct" },
  reverseSeq: { ta: "நேர்மறு (எதிர்)", en: "Reverse" },
  yearsShort: { ta: "ஆண்டு", en: "yrs" },
  ageLabel: { ta: "வயது", en: "Age" },
  bhriguBindu: { ta: "ப்ருகு பிந்து", en: "Bhrigu Bindu" },
  bhriguBinduDesc: {
    ta: "சந்திரன்–ராகு நடுப்புள்ளி — விதியின் உணர்திறன் புள்ளி.",
    en: "Moon–Rahu midpoint — a sensitive destiny point.",
  },
  specialLagnas: { ta: "சிறப்பு லக்னங்கள்", en: "Special Lagnas" },
  horaLagna: { ta: "ஹோரா லக்னம்", en: "Hora Lagna" },
  horaLagnaDesc: { ta: "செல்வம் / வளம்", en: "Wealth & prosperity" },
  ghatikaLagna: { ta: "கடிக லக்னம்", en: "Ghatika Lagna" },
  ghatikaLagnaDesc: { ta: "அதிகாரம் / சக்தி", en: "Power & authority" },
  arudhaLagna: { ta: "ஆரூட லக்னம்", en: "Arudha Lagna" },
  arudhaLagnaDesc: { ta: "பிம்பம் / காணப்படும் சுயம்", en: "Public image, perceived self" },
  karakamsa: { ta: "காரகாம்சம்", en: "Karakamsa" },
  karakamsaDesc: { ta: "நவாம்சத்தில் ஆத்மகாரகன் — ஆன்மிக / தொழில் அடிப்படை", en: "Atmakaraka in navamsa — spiritual & career signature" },
  house_: { ta: "பாவம்", en: "house" },
  fromLagna: { ta: "லக்னத்திலிருந்து", en: "from lagna" },
  currentPeriod: { ta: "தற்போதைய தசா", en: "Current period" },
  dashNeedChart: {
